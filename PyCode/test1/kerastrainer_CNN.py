...
from tensorflow.keras.layers import Dense, Dropout, Conv1D, Flatten, MaxPooling1D, GlobalAveragePooling1D, Reshape
...
INPUT_FILE_PATH = ['..\\..\\mit-bih-database\\103', '..\\..\\mit-bih-database\\106','..\\..\\mit-bih-database\\117']
...
# data_file, annotation_file = Read_Data_from_wfd(INPUT_FILE_PATH[2])
# input_dat_3, output_dat_3 = pre_process_data(data_file, annotation_file)
...
# training_output_dat = np.concatenate((output_dat_3, output_dat_3), axis=0)
...
#print(np.shape(training_input_dat))
model.add(Reshape((320, 1,), input_shape=(320,)))
model.add(Conv1D(40, 2, activation='relu', input_shape=(320,1)))
